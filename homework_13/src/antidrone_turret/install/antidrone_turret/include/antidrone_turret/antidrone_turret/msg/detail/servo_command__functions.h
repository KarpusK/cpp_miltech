...
#ifndef ANTIDRONE_TURRET__MSG__DETAIL__SERVO_COMMAND__FUNCTIONS_H_
#define ANTIDRONE_TURRET__MSG__DETAIL__SERVO_COMMAND__FUNCTIONS_H_
 ...
 * )) before or use
 * antidrone_turret__msg__ServoCommand__create()
 ...
 * calls
 * antidrone_turret__msg__ServoCommand__init().
...
/**
 * It calls
 * antidrone_turret__msg__ServoCommand__fini()
 ...
 * antidrone_turret__msg__ServoCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * antidrone_turret__msg__ServoCommand__Sequence__fini()
 * on the array,
...
#endif  // ANTIDRONE_TURRET__MSG__DETAIL__SERVO_COMMAND__FUNCTIONS_H_
